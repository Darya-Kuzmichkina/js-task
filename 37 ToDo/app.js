...
document.querySelector(".create").addEventListener("click", async () => {
  ...
  const ul = document.querySelector("body .list ul");
  ul.innerHTML += `<li style ="margin-top: 10px"; class="inpDel">${json.todo}<button onclick="deleteEl(${json.id}, event)"; class="delete"; style ="margin-left: 10px">Delete</button></li>`;
  ul.appendChild(li);
});
